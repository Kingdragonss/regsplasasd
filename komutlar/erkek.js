...
if(yaş.length > 100) return message.channel.send(`**<a:hydraalevv:808620322030878750> Üyenin yaşı 100'den büyük olamaz.**`)
...
<a:hydrayildizi3:791092780398673940> **Kayıt eden:** ${message.author} \`  { ${message.author.id} }  \` <a:hydrayildizi3:791092780398673940>
